...
public abstract class BaseQuery<E extends BaseEntity, I extends BaseInput<E>,ID, L extends BaseLogic<E, ID, R>,
    ...
    protected BaseQuery(BaseService<E, I, ID, L, M, R, RE> service) {
